...
public class FragmentAgo extends Fragment {

    public static Fragment newInstance() {
        FragmentAgo fragment = new FragmentAgo();
        return fragment;
    }
...
//        recyclerView.setAdapter(new RecyclerAdapter());
    ...
    private void initPage() {
        ...
        pullToLoadMoreRecyclerView = new PullToLoadMoreRecyclerView<MovieBean>(myswipeRefreshLayout, myrecyclerView, FragmentToday.MyRecyclerViewHolder.class) {
            @Override
            ...
            public String getApi() {
                ...
                //接口
                return "getMyHistoryMovieList?pageIndex=" + pageIndex + "&token=" + token + "&flag=ago";
            }
