...
public class FragmentMsg extends Fragment {
    ...
    private void initPage() {
        ...
        pullToLoadMoreRecyclerView = new PullToLoadMoreRecyclerView<NoticeBean>(myswipeRefreshLayout, myrecyclerView, FragmentGongGao.MyRecyclerViewHolder.class) {
            @Override
            ...
            public String getApi() {
                ...
                //接口
                return "getMsgList?pageIndex=" + pageIndex + "&token=" + token + "";
            }
