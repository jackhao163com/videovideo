...
public class MovieResultActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movieresult);
        ...
        itemClickSupport.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                ...
                Intent i = new Intent(MovieResultActivity.this,MovieDetailActivity.class);
...
//        pullToLoadMoreRecyclerView.putParam("orderId",orderId);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.setting:
                MovieResultActivity.this.finish();
                break;
        }
    }
...
//        R.layout.item_movie_like
        ...
        public void onBindRealData() {
            ...
            likemovieviews.setText(views+"次");
            Picasso.with(mContext)
                    .load(mData.getCover())
                    .into(likecover);
            if(taglistdata.size() > 0){
                for(MovieBean.DataBean.ItemsBean.TaglistBean tag : taglistdata){
                    TextView tagdiv = (TextView)LayoutInflater.from(mContext).inflate(R.layout.item_tag_div,null);
