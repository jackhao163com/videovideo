...
public class TwoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.e("chumingchao","twofragment create");
        mViewroot = (ViewGroup) inflater.inflate(R.layout.fragment_two, container, false);
        mShuaiXuan = mViewroot.findViewById(R.id.shuaixuan);
        mWebview = mViewroot.findViewById(R.id.pindao_webview);
        progressBar = (ProgressBar) mViewroot.findViewById(R.id.progressbar);
        mWebview.loadUrl("http://hgweb.joysw.win:82/#/channel?token=xxx");
