...
public class UserNameLoginActivity extends Activity implements View.OnClickListener,CompoundButton.OnCheckedChangeListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.login_back:
                startActivity(new Intent(UserNameLoginActivity.this, LoginActivity.class));
                finish();//关闭页面
                break;
            case R.id.password_forget:
                startActivity(new Intent(UserNameLoginActivity.this, PasswordRecoveryActivity.class));
                finish();//关闭页面
                break;
            case R.id.username_login:
                ...
                break;
            case R.id.register:
                startActivity(new Intent(UserNameLoginActivity.this, RegisterActivity.class));
                finish();//关闭页面
                break;
        }
    }
            ...
            public void run() {
                ...
                switch (registerToServer()){
                    case 1:
                    {
                        ...
                        startActivity(new Intent(UserNameLoginActivity.this, MainActivity.class));
                        finish();//关闭页面
                    }
                    break;
                    case -3:
...
//System.out.println(success);
    ...
    public void loadUserName() {
        if (!getAccount().equals("") || !getAccount().equals("请输入您的手机号")) {
            SharedPreferencesUtils helper = new SharedPreferencesUtils(this, "setting");
            helper.putValues(new SharedPreferencesUtils.ContentValue("username", getAccount()));
        }
    ...
    public void setLoginBtnClickable(boolean clickable) {
        ...
        UserNameLoginActivity.this.myHandler.sendMessage(msg);
    }
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(UserNameLoginActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            UserNameLoginActivity.this.mLoginBtn.setClickable(ison);
